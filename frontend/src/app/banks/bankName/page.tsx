...
import {StockDataTable} from "@/app/banks/bankName/file-data-table";
import {stockColumns} from "@/app/banks/bankName/file-columns";
...
const AdminProfilePage = () => {
  ...
  return (
    <div>
      ...
      <div className="mt-2">
        <Tabs defaultValue="account-list" className="w-full px-4">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="account-list">Account list</TabsTrigger>
            <TabsTrigger value="files">Files</TabsTrigger>
          </TabsList>
          <TabsContent value="account-list">
     <div className="px-4">
